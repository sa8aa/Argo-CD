  ...
  return (
    <div className="min-h-screen flex">
      ...
      <aside className="hidden lg:flex lg:w-1/2 relative overflow-hidden bg-[#0B1120] flex-col justify-between p-12">
        {/* Ambient glows */}
        <div className="pointer-events-none absolute -top-32 -left-20 w-[500px] h-[500px] rounded-full bg-[radial-gradient(circle,rgba(99,179,237,0.13)_0%,transparent_70%)]" />
        <div className="pointer-events-none absolute -bottom-24 -right-16 w-[400px] h-[400px] rounded-full bg-[radial-gradient(circle,rgba(167,139,250,0.10)_0%,transparent_70%)]" />

        {/* Brand */}
        <div className="relative z-10 flex items-center gap-3">
          <span className="text-xl font-extrabold tracking-tight text-[#f0f4ff]">
        ...
        <div className="relative z-10 space-y-5">
          <h1 className="text-[44px] font-black leading-[1.08] tracking-[-1.5px] text-[#f0f4ff]">
            Build Better<br />
        ...
        <div className="relative z-10 flex gap-10">
          {[
            ...
            <div key={label}>
              <p className="text-[28px] font-black text-[#f0f4ff]">{num}</p>
